package com.qk.plugin.javadoc.transformation;

import com.qk.plugin.javadoc.model.JavaDoc;
import com.qk.plugin.javadoc.model.JavaDocElements;
...
public class JavaDocBuilder {
   ...
   * @return the Java doc builder
   */
  public JavaDocBuilder addTag(String name, String tag) {
   ...
   * @return the Java doc builder
   */
  public JavaDocBuilder addTags(@NotNull Map<String, Collection<String>> tags) {
    Iterator<Entry<String, Collection<String>>> iterator = tags.entrySet().iterator();
    while (iterator.hasNext()) {
      Entry<String, Collection<String>> entry = iterator.next();
      String name = entry.getKey();
      Iterator<String> javaDocTagsIterator = entry.getValue().iterator();
      while (javaDocTagsIterator.hasNext()) {
        String javaDocTag = javaDocTagsIterator.next();
